...
export default function HomeView() {
  // useTranslations trong Client Component: đọc từ NextIntlClientProvider (đã bọc ở layout)
    ...
    <div style={{ backgroundColor: "#0D0B08", color: "#F5F0E8" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: isMobile ? "10px" : "16px" }}>
            ...
            <Link href="/login" style={{
              ...
              {isMobile ? t("nav.loginShort") : t("nav.loginFull")}
            </Link>
            <button
      ...
      <div style={{
        ...
        {isMobile ? (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
            {[
              { value: "50+", label: t("stats.dishes") },
              { value: "15", label: t("stats.tables") },
              { value: "4.9★", label: t("stats.rating") },
              { value: "8yr", label: t("stats.serving") },
            ].map((stat, idx) => (
              <div key={idx} style={{
      ...
      <section style={{ padding: isMobile ? "24px 16px" : "36px 40px" }}>
        <div style={{ marginBottom: "20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <Link href="/login" style={{ fontSize: "11px", color: "#FFC000", letterSpacing: "0.08em", textDecoration: "none" }}>
            {isMobile ? t("featured.viewAllShort") : t("featured.viewAllFull")}
          </Link>
        </div>
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            { label: t("why.freshDaily.label"), text: t("why.freshDaily.text") },
            { label: t("why.qrOrdering.label"), text: t("why.qrOrdering.text") },
            { label: t("why.familyRecipes.label"), text: t("why.familyRecipes.text") },
            { label: t("why.fastService.label"), text: t("why.fastService.text") },
          ].map((feature, idx) => (
            <div key={idx} style={{
      ...
      <footer style={{
        ...
        <p style={{ fontSize: "11px", color: "#8A7F72", margin: 0 }}>{t("footer.copyright")}</p>
        <div style={{ display: "flex", gap: "20px" }}>
          {[t("footer.menu"), t("footer.privacy"), t("footer.contact")].map((link) => (
